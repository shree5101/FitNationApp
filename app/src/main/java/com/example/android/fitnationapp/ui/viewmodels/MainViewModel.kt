...
import com.example.android.fitnationapp.other.SortType
...
class MainViewModel @ViewModelInject constructor(
    ...
    private val runsSortedByAvgSpeedInKMH = mainRepository.getAllRunsSortedByAvgSpeedInKMH()
    ...
    init {
        ...
        runs.addSource(runsSortedByAvgSpeedInKMH) {result ->
    ...
    fun sortRuns(sortType: SortType) = when(sortType) {
        ...
        SortType.AVG_SPEED -> runsSortedByAvgSpeedInKMH.value?.let { runs.value = it }
